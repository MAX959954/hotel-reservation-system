...
/** Matches CreateHotelRequest on the backend — companyId is required there too, the
 *  server just doesn't infer it, unlike Companies.submittedByUserId. */
...
export const ALL_AMENITIES: Amenity[] = [
  'WIFI', 'BREAKFAST', 'AIR_CONDITIONING', 'PARKING', 'POOL', 'GYM', 'SPA', 'BAR',
  'RESTAURANT', 'ROOM_SERVICE', 'AIRPORT_SHUTTLE', 'PET_FRIENDLY', 'ELEVATOR', 'LAUNDRY',
  'WORKSPACE', 'TV', 'COFFEE_MAKER', 'HAIR_DRYER', 'LUGGAGE_STORAGE', 'ACCESSIBLE',
  'EV_CHARGING', 'NON_SMOKING',
]
